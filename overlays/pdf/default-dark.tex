...
\newcommand{\fixsvg}[1]{
  \immediate\write18{perl -pi -e 's/fill="(?!none")[^"]+"/fill="\#fbf1c7"/g; s/stroke="(?!none")[^"]+"/stroke="\#fbf1c7"/g; s/font-family="[^"]*"/font-family="FiraCode Nerd Font Bold"/g; s/ style="[^"]*"//g' #1.svg}
}
